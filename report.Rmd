...
ggplot(td[-1,], aes(estimate, term, color = term)) +
    ...
    theme(legend.position = 'none',
          axis.text.y  = element_text(size=6, margin = margin(20,20,20,20)))
```
...
![Assumption Validation Regression](images/prelim_model_assumptions.jpg)
...
![Residual Diagnostic Panel](images/residual_diags.jpg)
...
![Model Selection](images/ms_firstanalysis.jpg)
...
![Top Adj. Rsq. / AIC / BIC Models](images/ms_fa_stats1.jpg)


![Top ASE and Cv Press Models](images/ms_fa_stats2.jpg)
...
![Model Performance Statistics](images/ms_model1.jpg)
...
![Model Performance Statistics](images/ms_model2.jpg)
...
![Model Performance Statistics](images/ms_model3.jpg)
...
![Model Performance Statistics](images/ms_model4.jpg)
...
![Model Performance Statistics](images/ms_model5.jpg)
...
![Model Performance Statistics](images/ms_model6.jpg)
...
![Model Performance Statistics](images/ms_model7.jpg)
...
![Final Kaggle Score](images/kaggle.jpg)
