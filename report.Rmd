...
We focused on two approaches, one geared towards finding the most performant model we could and one towards finding the most interpretable model we could. 
